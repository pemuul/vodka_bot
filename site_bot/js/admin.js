...
let modalMessageToClient = document.getElementById('writeToClient')
let btnMesToClient = document.getElementById('contact-client')
let btnsendTextMes = document.getElementById('sendTextMes')

/////btnMesToClient.addEventListener('click', () => {
/////  modalMessageToClient.style.display = 'flex'
/////})
/////
/////btnsendTextMes.addEventListener('click', () => {
/////  modalMessageToClient.style.display = 'none'
/////})
/////
/////function closwModalMessage(){
/////   modalMessageToClient.style.display = 'none'
/////}
///
///
/////let catalogAdmin = document.getElementById('catalogAdmin')
/////let infoOrderAdmin = document.getElementById('infoOrderAdmin')
/////
/////function addProductAdmin(){
/////  infoOrderAdmin.style.display = 'none';
/////  catalogAdmin.style.display = 'flex';
/////}

let productEditing = document.getElementById('productEditing')

function editingProduct(){
  productEditing.style.display = 'flex'
}