...
def edit_menu_kb(message, path) -> ReplyKeyboardMarkup:
    ...
    if tree_item.path != SPLITTER_STR:
        ...
        buttons.button(
            text=f'Вернуться назад ↩️', callback_data=f"b_{path_id}"
        )
...
def item_edit_kb(path_id):
    ...
    buttons.button(text='Вернуться назад ↩️', callback_data=AdminMenuEditCallbackFactory(path_id=path_id, button='RETURN'))
...
def other_item_edit_kb(path_id):
    ...
    buttons.button(text='========================', callback_data='pass')
    buttons.button(text='Вернуться назад ↩️', callback_data=AdminMenuEditCallbackFactory(path_id=path_id, button='EDIT'))
...
def mailing_kb(path_id):
    ...
    buttons.button(text='========================', callback_data='pass')
    buttons.button(text='Вернуться назад ↩️', callback_data=AdminMenuEditCallbackFactory(path_id=path_id, button='OTHER'))
...
def admin_buttons():
    ...
    buttons.button(text='Вернуться назад ↩️', callback_data=f"b_{0}")
...
def fill_wallet_kb():
    ...
    buttons.button(text='Вернуться назад ↩️', callback_data="admin_wallet")
